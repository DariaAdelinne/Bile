====================================================================
  P2: Profit companii > 40% (Kotlin TCP Server + PySpark Direct Stream)
====================================================================

LOGICA PYSPARK: profit mediu pe baza targetMean si targetLow
API TOKEN: brl7eb7rh5re1lvco7fg
