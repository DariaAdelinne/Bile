...
/**
 * BiddingProcessorMicroservice - nemodificat fata de laborator.
 * Primeste ofertele procesate de la MessageProcessor,
 * decide castigatorul (oferta maxima) si il anunta la Auctioneer.
 */
        ...
        receiveProcessedBidsObservable = Observable.create<String> { emitter ->
            while (true) {
                ...
                if (receivedMessage == null) {
                    ...
                    emitter.onError(Exception("MessageProcessorMicroservice s-a deconectat."))
                    break
                }
