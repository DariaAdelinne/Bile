"""
Script de configurare RabbitMQ pentru Subiect 19 — ErrorStatisticsProcessor.

Creeaza exchange-ul si toate cozile, inclusiv cea noua pentru erori:
  error_stats.queue <- error_stats.routingkey  (TOATE microserviciile -> ErrorStatisticsProcessor)
...
QUEUES = [
    ...
    ('error_stats.queue',        'error_stats.routingkey'),      # TOATE -> ErrorStatisticsProcessor (NOU)
]
...
if __name__ == '__main__':
    ...
    with pika.BlockingConnection(params) as conn:
        ...
        for queue_name, routing_key in QUEUES:
            ...
            label = " <-- NOU" if queue_name == "error_stats.queue" else ""
