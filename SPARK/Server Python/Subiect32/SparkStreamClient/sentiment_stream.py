...
Preia stiri de la serverul TCP Python (localhost:9999) si clasifica
...
Algoritm de clasificare:
  ...
  - se numara cate cuvinte din titlu/summary apar in RDD-ul de cuvinte pozitive
...
Rulare:
  ...
  (serverul TCP trebuie sa ruleze inainte)
"""
...
def make_classifier(pos_set, neg_set):
    ...
    def classify(article: dict) -> str:
        # combinam titlul cu summary-ul pentru analiza
...
def make_rdd_processor(sc, pos_words_bc, neg_words_bc):
    ...
    def process_rdd(rdd):
        ...
        # clasifica fiecare stire folosind seturile de cuvinte din broadcast
...
def main():
    ...
    # flux de date direct (direct stream) de la serverul TCP Python
